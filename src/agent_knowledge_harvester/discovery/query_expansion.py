...
CHINESE_TOPIC_TERMS: dict[KnowledgeTopic, list[str]] = {
    ...
    KnowledgeTopic.CLAUDE_CODE: ["Claude Code", "Claude Code 教程", "Claude Code 智能体"],
    ...
    KnowledgeTopic.HARDNESS: ["智能体任务难度", "Agent 难例", "智能体失败模式"],
    ...
    KnowledgeTopic.OPENCLAW: ["OpenClaw", "OpenClaw 安全", "Claw 工具"],
    ...
    KnowledgeTopic.SKILLS: ["Agent skills", "智能体技能", "Claude Code skills"],
